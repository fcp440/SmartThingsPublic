...
private parameterMap() {[
	...
	[key: "motionCancelationDelay", num: 6, size: 2, type: "number", def: 30, min: 1, max: 32767, title: "Motion detection - alarm cancellation delay", 
		descr: "Time period after which the motion alarm will be cancelled in the main controller and associated devices."], 
	...
	[key: "motionNightDay", num: 9, size: 2, type: "number", def: 200, min: 1, max: 32767, title: "Motion detection - night/day", 
		descr: "This parameter defines the difference between night and day in terms of light intensity, used in parameter 8."], 
	[key: "tamperSensitivity", num: 20, size: 1, type: "number", def: 20, min: 0, max: 121, title: "Tamper - sensitivity", 
		descr: "This parameter determines the change in force acting on the device, that will result in reporting tamper alarm - g-force acceleration."], 
	...
	[key: "temperatureThreshold", num: 60, size: 2, type: "number", def: 10, min: 0, max: 255, title: "Temperature report - threshold", 
		descr: "This parameter determines the change in measured temperature that will result in new temperature report being sent to the main controller."], 
	[key: "temperatureMeasuringInterval", num: 62, size: 2, type: "number", def: 900, min: 0, max: 32767, title: "Temperature measuring - interval", 
		descr: "Time interval between consecutive temperature measurements. The shorter the time, the more frequently the temperature will be measured, but the battery life will shorten."],
	...
	[key: "ledBrightness", num: 81, size: 1, type: "number", def: 50, min: 0, max: 100, title: "Visual LED indicator - brightness", 
		descr: "This parameter determines the brightness of the visual LED indicator when indicating motion."], 
	[key: "ledLowBrightness", num: 82, size: 2, type: "number", def: 100, min: 0, max: 32767, title: "Visual LED indicator - illuminance for low indicator brightness", 
		descr: "Light intensity level below which brightness of visual indicator is set to 1%"], 
	...
	[key: "ledTemperatureBlue", num: 86, size: 2, type: "number", def: 18, min: 0, max: 255, title: "Visual LED indicator - temperature for blue colour", 
		descr: "This parameter determines minimal temperature that will result in blue visual indicator colour. Relevant only when parameter 80 has been properly configured."], 
	[key: "ledTemperatureRed", num: 87, size: 2, type: "number", def: 28, min: 0, max: 255, title: "Visual LED indicator - temperature for red colour", 
		descr: "This parameter determines minimal temperature that will result in red visual indicator colour. Relevant only when parameter 80 has been properly configured."], 
	[key: "ledTamperAlarm", num: 89, size: 1, type: "enum", options: [0: "Tamper alarm is not indicated", 1: "Tamper alarm is indicated (default)"], def: "1", title: "Visual LED indicator - tamper alarm", 
		descr: "This parameter allows to enable/disable indicating tamper alarm (flashing white, red and blue)"]
]}
