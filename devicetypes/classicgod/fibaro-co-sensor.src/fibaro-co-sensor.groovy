 ...
 */
metadata {
	definition (name: "Fibaro CO Sensor", namespace: "ClassicGOD", author: "Artur Draga") {	
	...
	tiles (scale: 2) {
		multiAttributeTile(name:"FGDW", type:"lighting", width:6, height:4) {
			tileAttribute("device.carbonMonoxide", key:"PRIMARY_CONTROL") {
				...
				attributeState("tested", label:"tested", icon:"https://raw.githubusercontent.com/ClassicGOD/SmartThingsPublic/master/devicetypes/classicgod/fibaro-co-sensor.src/images/device_co_2.png", backgroundColor:"#e86d13")
			}
		...
		standardTile("temperatureAlarm", "device.temperatureAlarm", inactiveLabel: false, width: 3, height: 2, decoration: "flat") {
			...
			state "clear", label:'', backgroundColor:"#ffffff" , icon: "https://raw.githubusercontent.com/ClassicGOD/SmartThingsPublic/master/devicetypes/classicgod/fibaro-co-sensor.src/images/heat_detector0.png"
			state "overheat", label:'Overheat', backgroundColor:"#d04e00", icon: "https://raw.githubusercontent.com/ClassicGOD/SmartThingsPublic/master/devicetypes/classicgod/fibaro-co-sensor.src/images/heat_detector1.png"
		}

		standardTile("tamper", "device.tamper", inactiveLabel: false, width: 3, height: 2, decoration: "flat") {
			state "clear", label:'', icon: "https://raw.githubusercontent.com/ClassicGOD/SmartThingsPublic/master/devicetypes/classicgod/fibaro-co-sensor.src/images/tamper_detector0.png"
			state "detected", label:'', icon: "https://raw.githubusercontent.com/ClassicGOD/SmartThingsPublic/master/devicetypes/classicgod/fibaro-co-sensor.src/images/tamper_detector100.png"
		}
